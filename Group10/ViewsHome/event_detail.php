<div class="grid">
    ...
    <div class="grid__row app__content">
        ...
        <div class="grid__column-9">
            ...
            <div class="date__event-detail">
                <i class="fa fa-calendar"> <span class="date-address"> <?=$rowEvent["Date"]?></span></i>
            </div>
            <div class="hr__event-detail">
            ...
            <div class="ed-content">
                <div class="event-content">
                    ...
                    $sections = explode("\n\n", $description); // Sử dụng "\n\n" nếu các đoạn được phân tách bằng xuống dòng
                    // $sections = explode(".", $description); // Sử dụng "." nếu các đoạn được phân tách bằng dấu chấm

                    $sectionNumber = 1;
                    $totalSections = count($sections);

                    foreach ($sections as $section) {
                        if ($sectionNumber === 3 && $sectionNumber < $totalSections) {
                            ?>
                            <div class="e-img">
                        ...
                        echo "<p class=\"section section-$sectionNumber\">$section</p>";
                        $sectionNumber++;
                    }

                    // Hiển thị hình ảnh ở cuối cùng nếu $sectionNumber < 4
                    if ($sectionNumber < 3) {
                        ?>
                            <div class="e-img">
                                <img src="images/<?=$rowEvent["Image"]?>">
                ...
                <div class="source__event-details">Nguồn: Group 4</div>
            </div>
        </div>
