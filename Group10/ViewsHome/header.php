        ...
        <div class="header-top">
            <div class="header-top-content">
                ...
                <div class="notification htop">
                    ...
                    <marquee class="text-run">Chào mừng bạn đến với nhà sách Group10</marquee>
                </div>
                <div class="contact-info htop">
                <span class="email">
                        <i class="fa-solid fa-envelope"></i>
                        : Group10BookStore@gmail.com
                    </span>
                    <span class="phone">
            ...
            <div class="header-bottom-content">
                ...
                <div class="list htop">
                    <ul>
                        ...
                        <li><a href="?module=event"><span class="list-text">SỰ KIỆN</span></a>
                        </li>
                        <li><a href="#"><span class="list-text">GIỚI THIỆU</span></a>
                            <ul>
                                ...
                                <li><a href="?module=faqs">FAQs</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
