        ...
        <div id="detail">
            <form name="f2" id="f1" action="?module=checkout&act=buy" method="post" onSubmit="return kt();">
                ...
                <tr>
                    ...
                    <td width="380"><input type="text" name="hoten" id="hoten" class="auth-form__input" required></td>
                </tr>
                <tr>
                    <td width="150" height="30">Địa chỉ:</td>
                    <td width="380"><input type="text" name="diachi" id="diachi" class="auth-form__input" required></td>
                </tr>
                <tr>
                    <td width="150" height="30">Điện thoại:</td>
                    <td width="380"><input type="text" name="dienthoai" id="dienthoai" class="auth-form__input" required></td>
                </tr>
                <tr>
                    <td width="150" height="30">Ghi chú:</td>
                    <td width="380"><input type="text" name="note" id="note" class="auth-form__input"></td>
                </tr>
                <tr>
                    <td></td>
                    <td><input style="margin-top: 20px;" type="submit" name="btnbuy" id="btnbuy" class="btn btn--primary" value="Đồng ý"></td>
                </tr>
                </table>
            </form>
        </div>
