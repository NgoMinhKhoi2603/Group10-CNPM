    ...
    <div id="detail">
        <form name="form1" method="post" action="?module=<?=$module?>&act=handleadd">
            ...
            <tr>
                ...
                <td width="380"><input type="text" name="categoryname" id="categoryname" class="auth-form__input"></td>
            </tr>
            <tr>
                <td height="30">Mô tả:</td>
                <td><textarea name="categorydescription" id="categorydescription" class="auth-form__input" rows="5" cols="50"></textarea></td>
            </tr>
            <tr>
                <td></td>
