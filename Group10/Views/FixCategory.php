    ...
    <div id="detail">
        <form name="form1" method="post" action="?module=<?=$module?>&act=handlefix&id=<?=$row["Id"]?>">
            ...
            <tr>
                ...
                <td width="380"><input type="text" name="categoryname" id="categoryname" class="auth-form__input" value="<?=$row["Name"]?>"></td>
            </tr>
            <tr>
                <td height="30">Mô tả:</td>
                <td><textarea name="categorydescription" id="categorydescription" class="auth-form__input" rows="5" cols="50"><?=$row["Description"]?></textarea></td>
            </tr>
            <tr>
                <td></td>
