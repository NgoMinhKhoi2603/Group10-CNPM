    ...
    <div id="detail">
        <form name="form1" method="post" action="?module=<?=$module?>&act=handlefix&id=<?=$row["Id"]?>" enctype="multipart/form-data">
            ...
            <tr>
                ...
                <td width="380"><input type="text" name="name" id="name" class="auth-form__input" value="<?=$row["Name"]?>"></td>
            </tr>
            <tr>
                <td height="60">Ngày diễn ra:</td>
                <td width="380"><input type="date" name="date" id="date" class="auth-form__input" value="<?=$row["Date"]?>"></td>
            </tr>
            <tr>
                <td height="120">Hình ảnh:</td>
                <td>
