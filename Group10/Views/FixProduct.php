    ...
    <div id="detail">
        <form name="form1" method="post" action="?module=<?=$module?>&act=handlefix&id=<?=$row["Id"]?>" enctype="multipart/form-data">
            ...
            <tr>
                ...
                <td width="630">
                <select name="selectCategory" id="selectCategory" class="auth-form__input">
            ...
            <tr>
                ...
                <td width="630">
                <select name="selectAuthor" id="selectAuthor" class="auth-form__input">
            ...
            <tr>
                ...
                <td width="380"><input type="text" name="t1" id="t1" class="auth-form__input" value="<?=$row["Name"]?>"></td>
            </tr>
            <tr>
                <td height="30">Số lượng:</td>
                <td><input type="text" name="t2" id="t2" class="auth-form__input" value="<?=$row["Quantity"]?>"></td>
            </tr>
            <tr>
                <td height="30">Giá:</td>
                <td><input type="text" name="t3" id="t3" class="auth-form__input" value="<?=$row["Price"]?>"></td>
            </tr>
            <tr>
                <td height="30">Khối lượng:</td>
                <td><input type="text" name="t4" id="t4" class="auth-form__input" value="<?=$row["Mass"]?>"></td>
            </tr>
            <tr>
                <td height="60">Số trang:</td>
                <td><input type="text" name="t5" id="t5" class="auth-form__input" value="<?=$row["NumberPage"]?>"></td>
            </tr>
            <tr>
                ...
                <tr>
                <td height="60">Mô tả:</td>
                <td><textarea name="t6" id="t6" class="auth-form__input" rows="5" cols="50"><?=$row["Description"]?></textarea></td>
            </tr>
            <tr>
                <td></td>
