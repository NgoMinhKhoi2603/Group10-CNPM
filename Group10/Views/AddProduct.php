    ...
    <div id="detail">
        <form name="form1" method="post" action="?module=<?=$module?>&act=handleadd" enctype="multipart/form-data">
            ...
            <tr>
                ...
                <td width="380"><input type="text" name="t1" id="t1" class="auth-form__input"></td>
            </tr>
            <tr>
                <td height="30">Số lượng:</td>
                <td><input type="text" name="t2" id="t2" class="auth-form__input"></td>
            </tr>
            <tr>
                <td height="30">Giá:</td>
                <td><input type="text" name="t3" id="t3" class="auth-form__input"></td>
            </tr>
            <tr>
                <td height="30">Khối lượng:</td>
                <td><input type="text" name="t4" id="t4" class="auth-form__input"></td>
            </tr>
            <tr>
                <td height="30">Số trang:</td>
                <td><input type="text" name="t5" id="t5" class="auth-form__input"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><textarea name="t6" id="t6" rows="5" cols="50" class="auth-form__input"></textarea></td>
            </tr>
            <tr>
                <td></td>
                <td><input type="submit" name="button" id="button" value="Đồng ý" class="btn btn--primary"></td>
            </tr>
            </table>
        </form>
